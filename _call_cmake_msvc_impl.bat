...
@if not "%TOOLSET%"=="msvc2022" goto CHECK_GENERATOR_MSVC2026
@set GENERATOR="Visual Studio 17 2022"
@goto GENERATOR_GOOD

:CHECK_GENERATOR_MSVC2026
@if not "%TOOLSET%"=="msvc2026" goto CHECK_GENERATOR_MSVC2064
@set GENERATOR="Visual Studio 18 2026"
@goto GENERATOR_GOOD


:CHECK_GENERATOR_MSVC2064
