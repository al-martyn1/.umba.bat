...
@set CLOCMDSUBDIR=\%CLOCMD%

:RUN_CLOC_ALL
@set CLOCOUTDIR=%CLOCOUTDIR%%CLOCMDSUBDIR%
@set CLOCOUTFORMATOPT=
@set CLOCOUTFORMATEXT=txt
@call :RUN_CLOCK
@set CLOCOUTFORMATOPT=--md
@set CLOCOUTFORMATEXT=md%CLOCMDEXTSUFFIX%
@call :RUN_CLOCK
exit /B 0

:RUN_CLOCK
@rem %CLOCINPUTDIR%
cloc %CLOCOUTFORMATOPT% --vcs=git                  --exclude-dir=%CLOCEXCLUDEDIRS% --by-file-by-lang --out=%CLOCOUTDIR%\sources-stat.%CLOCOUTFORMATEXT%
cloc %CLOCOUTFORMATOPT% --vcs=git --by-percent cmb --exclude-dir=%CLOCEXCLUDEDIRS% --by-file-by-lang --out=%CLOCOUTDIR%\sources-stat-by-percent.%CLOCOUTFORMATEXT%
exit /B 0
...
Usage: cloc.exe [options] <file(s)/dir(s)/git hash(es)> | <set 1> <set 2> | <report files>
 ...
 Processing Options
   ...
   --by-file-by-lang         Report results for every source file encountered
                             in addition to reporting by language.
   --config <file>           Read command line switches from <file> instead of
                             the default location of C:\Users\mag\AppData\Roaming\cloc.
                             ...
                             take priority over C:\Users\mag\AppData\Roaming\cloc.
