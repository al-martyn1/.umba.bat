...
@rem
@rem Now we can set custom OUTROOTPATHS list before calling this file
@set OUTROOTPATHS=%OUTROOTPATHS% %MSVC_OLD_NAMES% %VS2022_NAMES% %VS2019_NAMES% %VS2017_MSB_NAMES% %VS2017_NAMES% %VS2015_NAMES% %VS2013_NAMES% %GCC130_NAMES% %GCC81_NAMES% %GCC73_NAMES% %GCC47_NAMES% %COMPAT_NAMES% %CLANG12_NAMES%
@rem
