...
@set OUTROOTPATHS=%OUTROOTPATHS% %MSVC_OLD_NAMES% %COMPAT_NAMES% %CLANG12_NAMES% %GCC47_NAMES% %GCC73_NAMES% %GCC81_NAMES% %GCC130_NAMES% %VS2013_NAMES% %VS2015_NAMES% %VS2017_MSB_NAMES% %VS2017_NAMES% %VS2019_NAMES% %VS2022_NAMES%
@rem
